...
1. Apply and verify all additive migrations, including `20260831120000_add_razorpay_webhook_claim`, before deploying the application code with `RAZORPAY_MULTI_METHOD_SUBSCRIPTIONS_ENABLED=false`.
