...
export async function getStudentSeatingSnapshot(
  ...
  // ⚡ Bolt: Replaced O(N) findMany + length with O(1) database-level relational count
  // Impact: Reduces memory overhead and payload size when checking distinct seated students.
